...
<h3 class="text-gray-700 text-3xl font-bold">Marche</h3>

<div class="mt-10">
    <a href="{{route('marche.create')}}" class="px-6 py-3 bg-blue-600 rounded-md text-white font-medium tracking-wide hover:bg-blue-300">Crea nuova marca</a>
</div>
