...
<div class="mt-10">
    <a href="{{route('operatori.create')}}" class="px-6 py-3 bg-blue-600 rounded-md text-white font-medium tracking-wide hover:bg-blue-300">Aggiungi nuovo operatore</a>
</div>
                    ...
                    @forelse ($operatori as $operatore)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                <a href="{{ route('operatori.edit', [$operatore->id])}}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            </td>
                        </tr>
                    @empty
                    @endforelse
