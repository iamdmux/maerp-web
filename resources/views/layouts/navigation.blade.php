<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200 font-roboto">
    ...
    <div class="flex items-center justify-center mt-8">
        ...
        <nav class="mt-10">
            ...
            <a class="flex items-center mt-4 py-2 px-6 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('lotti.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('lotti.index') }}">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center mt-4 py-2 px-6 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('marche.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('marche.index') }}">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
