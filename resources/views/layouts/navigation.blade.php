<div x-data="navigation()" @sidebar-open="sidebarOpen = !sidebarOpen" class="flex h-screen bg-gray-200 font-roboto">
    ...
    <div class="mt-8 pl-6">
        ...
        <nav class="mt-10">
            ...
            {{-- VENDITE --}}
            <div @click="open('vendite')" class="cursor-pointer flex items-center mt-2 py-1 px-6 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
            ...
            {{-- ACQUISTI --}}
            <div @click="open('acquisti')" class="cursor-pointer flex items-center mt-2 py-1 px-6 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path>
                </svg>
            ...
            {{-- MAGAZZINO --}}
            <div @click="open('magazzino')" class="cursor-pointer flex items-center mt-2 py-1 px-6 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a x-show="isOpenMagazzino()" style="display:none" class="flex items-center mt-2 py-1 pl-8 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('lotti.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('lotti.index') }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a x-show="isOpenMagazzino()" style="display:none" class="flex items-center mt-2 py-1 pl-8 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('marche.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('marche.index') }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {{-- Blackbox --}}
                <div @click="open('blackbox')" class="cursor-pointer flex items-center mt-2 py-1 px-6 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                <a x-show="isOpenBlackbox()" style="display:none" class="flex items-center mt-2 py-1 pl-8 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('lavorazioni.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('lavorazioni.index') }}">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <a x-show="isOpenBlackbox()" style="display:none" class="flex items-center mt-2 py-1 pl-8 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('operatori.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('operatori.index') }}">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <a x-show="isOpenBlackbox()" style="display:none" class="flex items-center mt-2 py-1 pl-8 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{url()->current() == route('capi.index') ? 'bg-gray-700 text-blue-400' : ''}}" href="{{ route('capi.index') }}">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
