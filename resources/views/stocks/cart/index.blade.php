    ...
    <div class="lg:w-3/5">
                ...
                <div class="py-3 border-b border-grey-dark flex-row justify-between items-center mb-0 md:flex">
                    <form action="{{route('cart.update', $item->pivot->id)}}" method="POST">
                        ...
                        <button onclick="return confirm('Vuoi togliere questo prodotto dal carrello?')">
                            <svg class="w-6 h-6 text-grey-800 mr-6 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                        </button>
                    </form>
                    <div class="w-1/2 lg:w-3/5 xl:w-1/2 flex flex-row items-center border-b-0 border-grey-dark pt-0 pb-0 text-left">
                        ...
                        <span class="font-hk  text-base mt-2 ml-4">{{$item->codice_articolo}}</span>
                    </div>
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-8 sm:pt-12">
            ...
            <a href="{{route('cart.index')}}"
                class="px-6 py-2 font-semibold rounded-xl bg-black text-white hover:bg-gray-800">Aggiorna Carrello
            </a>
        </div>
    </div>
        ...
        <form action="{{route('orders.store')}}" method="POST">
            ...
            <div class="bg-gray-200 py-8 px-8 rounded">
                ...
                <div>
                    ...
                    <p class="font-hk  text-sm pb-4">Special instructions for us</p>
                    <label for="cart_note"
                ...
                <div class="mb-12 pt-4">
                    ...
                    {{-- <div class="border-b border-grey-darker pb-1 flex justify-between">
                        <span class="font-hk ">Subtotal</span>
                        <span class="font-hk ">$236</span>
                    </div> --}}
                    {{-- <div class="border-b border-grey-darker pt-2 pb-1 flex justify-between">
                        <span class="font-hk ">Coupon applied</span>
                        <span class="font-hk ">-$36</span>
                    </div> --}}
