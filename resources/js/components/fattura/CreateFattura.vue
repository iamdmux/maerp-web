    ...
    <div v-if="tab_show_cliente">
      <div class="m-6"> 
        <div>
          ...
          <input required class="input-small w-36" autocomplete="off" type="text" name="ragione_sociale">
        </div>
        <div class="flex flex-wrap">
          <div>
            ...
            <input class="input-small w-36" autocomplete="off" type="text" name="indirizzo">
          </div>
          <div>
            <p class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
                città
            </p>
            <input class="input-small w-36" autocomplete="off" type="text" name="citta">
          </div>
          <div>
            <p class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
                cap
            </p>
            <input class="input-small w-36" autocomplete="off" type="text" name="cap">
          </div>
          <div>
            <p class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
                provincia
            </p>
            <input class="input-small w-36" autocomplete="off" type="text" name="provincia">
          </div>
          <div>
            <p class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
                note indirizzo
            </p>
            <textarea rows="4" cols="15" autocomplete="off" class="text-sm" name="note_indirizzo"></textarea>
          </div>
        </div>
        <div class="flex flex-wrap">
          <div>
            ...
            <select autocomplete="off" class="input-small rounded-md border-gray-200" type="text" name="paese">
          ...
          <div>
            ...
            <input class="input-small w-36" autocomplete="off" type="text" name="partita_iva">
          </div>
          <div>
            <p class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
                codice fiscale
            </p>
            <input class="input-small w-36" autocomplete="off" type="text" name="codice_fiscale">
          </div>
        </div>
      </div>
    </div>
        ...
        <div>
          ...
          <div class="flex flex-wrap mx-6 my-3">
            <div>
                ...
                <!-- <p class="absolute right-0 top-0 mt-2 mr-6 text-gray-800">%</p> -->
                </div>
            </div>
            <div class="ml-8">
                <p class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
      ...
      <div v-if="tab_show_opzioni_avanzate">
        ...
        <div>
          <div class="mx-6 my-3">
            ...
            <input autocomplete="off" class="input-small" type="text" name="costo_bollo" placeholder="2,00">
          </div>
        </div>
        <div class="flex">
          <label class="pb-1 text-left text-xs leading-4 font-medium text-gray-800 uppercase tracking-wider">
...
export default {
  ...
  setup(props){
    ...
    return {route, csrf, tab_show_cliente, tab_show_dati_documento, tab_show_contributi_ritenute, tab_show_opzioni_avanzate, tab_show_personalizzazione, tab_show_note_doc}
  }
}
</script>